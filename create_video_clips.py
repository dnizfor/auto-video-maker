...
def create_video_clip(word, mean, lang1, lang2):
    ...
    final_clip.write_videofile(f"clips/{word}.mp4", fps=1)

    # Delete the temporary audio files
    os.remove(f"{word}.mp3")
    os.remove(f"{mean}.mp3")
